...
\begin{fichacatalografica}
    ...
    \includepdf{ficha-catalografica.pdf} % Uncomment this
...
\include{chapters/fundamentacaoteorica}
\include{chapters/metodosutilizados}
...
\include{appendix/codigosflutter}
\include{appendix/testes}
